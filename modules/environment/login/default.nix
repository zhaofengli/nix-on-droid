  ...
  config = {
    ...
    environment.files = {
      ...
      prootStatic =
        let
          crossCompiledPaths = {
           aarch64 = "/nix/store/njvidbq5xw5xhyw87dk9bxw8akhih373-proot-termux-aarch64-unknown-linux-android-unstable-2021-05-03";
           i686 = "/nix/store/y7jja1ph7bpna7cxb43v3z9fqdkahbb8-proot-termux-i686-unknown-linux-android-unstable-2021-05-03";
          };
        in
